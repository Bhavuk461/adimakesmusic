    ...
    <section id="sound" className="relative bg-[#f5f4f3] pb-24 pt-28 text-black md:pb-32 md:pt-36">
      <div className="mx-auto max-w-6xl px-4 md:px-6">
        <div className="mb-10 flex flex-wrap items-end justify-between gap-6 md:mb-16">
          <div>
            <p className="mb-3 text-[10px] uppercase tracking-[0.5em] text-neutral-500 md:text-[11px]">
              01 — the shelf
            </p>
          ...
          <p className="max-w-[16rem] text-right text-[9px] uppercase leading-loose tracking-[0.25em] text-neutral-500 md:text-[11px]">
        ...
        <p className="mt-10 text-center text-[9px] uppercase tracking-[0.4em] text-neutral-400 md:text-[10px]">
